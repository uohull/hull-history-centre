...
describe Ead::Item do
  ...
  describe '.to_solr' do
    ...
    it 'converts attributes to a hash of solr fields' do
      attributes = { id: id, title: title, collection_id: collection_id, collection_title: collection_title, series_title: series_title, repository: repo, extent: extent, access: access, description: desc }
